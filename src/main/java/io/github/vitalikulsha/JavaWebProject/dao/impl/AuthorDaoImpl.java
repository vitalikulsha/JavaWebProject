...
import io.github.vitalikulsha.JavaWebProject.dao.constant.sqlquery.AuthorSqlQuery;
...
public class AuthorDaoImpl extends AbstractDao<Author> implements AuthorDao {
    ...
    public AuthorDaoImpl() {
        super(RowMapperFactory.instance().authorRowMapper(), authorSqlQuery.FIND_ALL, authorSqlQuery.FIND_BY_ID);
    }
